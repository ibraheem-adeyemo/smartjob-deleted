...
exports.statusTitles = exports.constStrings = void 0;
var statusTitles = {
  success: 'success',
  error: 'error'
};
exports.statusTitles = statusTitles;
var constStrings = {
...
exports.constStrings = constStrings;
...
exports.PHONE_NOT_FOUND_ERR = "Phone number can not be found", exports.PHONE_ALREADY_EXISTS_ERR = "Phone number already exist", exports.USER_NOT_FOUND_ERR = "User can not be found", exports.INCORRECT_OTP_ERR = "Incorect OTP", exports.ACCESS_DENIED_ERR = "Access denied for the normal user", exports.EMAIL_ALREADY_EXIST = "Email already exist";
exports.ACCOUNT_HAS_ALREADY_VERIFIED = "Your account has already been verified";
exports.INCORECT_OTP = "The OTP is wrong", exports.EMAIL_VERIFIED_SUCCESSFULLY = "Email has been verified";
...
exports.ADDRESS_ALREADY_CREATED = 'You have registered a location do you want to change your location';
exports.ACCOUNT_HAS_NOT_BEEN_VERIFIED = 'You have not verified your email account';
exports.EMAIIL_CAN_NOT_BE_FOUND = "The email can not be found", exports.ADDRESS_CAN_NOT_BE_FOUND = "The address with the addressId can not be found";
exports.ADDRESS_UPDATED_SUCCESSFULLY = "Address is updated successfully", exports.SERVICE_NOT_FOUND = "Service is not found", exports.BAD_REQUEST = "Bad request";
