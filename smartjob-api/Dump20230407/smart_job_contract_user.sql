...
CREATE TABLE `contract_user` (
  ...
  KEY `userId` (`userId`),
  CONSTRAINT `contract_user_ibfk_1` FOREIGN KEY (`contractId`) REFERENCES `contracts` (`id`),
  CONSTRAINT `contract_user_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
-- Dump completed on 2023-04-07 18:02:52
