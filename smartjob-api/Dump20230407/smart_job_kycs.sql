...
CREATE TABLE `kycs` (
  ...
  `NINNumber` varchar(255) DEFAULT NULL,
  `userId` int DEFAULT NULL,
  `isKycVerified` tinyint(1) DEFAULT '0',
  `votersCard` varchar(255) DEFAULT NULL,
  `utilityBill` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `kycs_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
-- Dump completed on 2023-04-07 18:02:22
