...
DROP TABLE IF EXISTS `bookinghistories`;
...
LOCK TABLES `bookinghistories` WRITE;
/*!40000 ALTER TABLE `bookinghistories` DISABLE KEYS */;
/*!40000 ALTER TABLE `bookinghistories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-07 18:02:50
