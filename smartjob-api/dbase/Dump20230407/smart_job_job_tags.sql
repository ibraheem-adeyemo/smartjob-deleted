...
CREATE TABLE `job_tags` (
  ...
  KEY `jobId` (`jobId`),
  KEY `tagId` (`tagId`),
  CONSTRAINT `job_tags_ibfk_1` FOREIGN KEY (`jobId`) REFERENCES `jobs` (`id`),
  CONSTRAINT `job_tags_ibfk_2` FOREIGN KEY (`tagId`) REFERENCES `tags` (`id`)
...
-- Dump completed on 2023-04-07 18:02:49
